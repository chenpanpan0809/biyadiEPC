...
TabPanel = function (config) {
    ...
    //console.log("1、render="+this.render.width())
...
TabPanel.prototype = {
    //初次加载渲染界面
    init: function () {
        //console.log("2、render="+this.render.width())
        var tabEntity = this;

        if (this.autoResizable) {
            this.widthResizable = this.heightResizable = true;
            //console.log("3、render="+this.render.width())
            this.render.css('overflow', 'hidden');
            //console.log("4、render="+this.render.width())
        ...
        //console.log("5、render="+this.render.width())
        //console.log("this.width="+this.width)
        //this.render.width(this.width);
        //console.log("6、render="+this.render.width())
...
//      console.log("tabpanelW="+this.render.width());
        this.tabpanel.height(this.render.height() - hwFix);
//      console.log("tabpanelH="+this.render.height());
        ...
        //console.log('tabpanel_tab_content:'+this.tabpanel_tab_content.get(0));
    ...
    addTab: function (tabitem) {
        ...
        //当没有选项卡时,如果已经滚动结束,则添加选项卡
            ...
            //    为tab html_content       添加高属性
            content.height(this.tabpanel_content.height() - 5);
    ...
    resize: function () {
        ...
        if (this.heightResizable) {
            ...
            //修改html_content的值解决外边框问题
            $(".html_content").height(this.tabpanel_content.height() - 5);
        }
